...
// **********************************************
// NOTE: demoTasks অ্যারেটি সম্পূর্ণরূপে মুছে ফেলা হয়েছে
// **********************************************
                            ...
                            {heroSlides.map((slide, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                        <Link to={slide.link} className={primaryButtonClass}>
                                            {slide.cta}
                                            <ArrowRight className="ml-2 h-5 w-5" />
                                        </Link>
                                        <Link to="/browse-tasks" className={outlineButtonClass}>
      ...
      <section className="py-16 lg:py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {isLoading ? (
                        ...
                        // *** JobCard কম্পোনেন্টটি ইমপোর্ট করা initialTasks ডেটা দিয়ে রেন্ডার করা হয়েছে ***
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 p-8 md:p-12 text-center max-w-4xl mx-auto shadow-xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link to="/browse-tasks" className={outlineButtonClass}>Browse Tasks</Link>
                        </div>
                    </div>
                </div>
            </section>
