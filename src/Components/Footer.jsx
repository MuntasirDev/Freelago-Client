...
const Footer = () => {
    return (
        // Replaced bg-secondary/50 and border-border
        <footer className="bg-gray-100 border-t border-gray-200 dark:bg-gray-900 dark:border-gray-800">
            {/* Assuming container-custom is max-width container with padding */}
...
                            <a
                                href="#"
                                // Replaced bg-background, text-muted-foreground, hover:text-primary, hover:bg-primary/10
...
                            <li>
                                {/* Replaced text-muted-foreground and hover:text-primary */}
                                <Link to="/browse-tasks" className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 transition-colors">
                                    Browse Tasks
                                </Link>
                            </li>
                            <li>
                                <Link to="/add-task" className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 transition-colors">
                                    Post a Task
                                </Link>
                            </li>
                            <li>
...
                {/* Replaced border-border and text-muted-foreground */}
